                ...
                <div className="dropzone-text">
                  {isDragActive ? (
                    ...
                    <>
                      ...
                      <br />
                      <small>Supports PDF, TXT, DOCX, JPG/PNG (location maps, site photos), ZIP (max 10MB each, up to 10 files)</small>
                    </>
                  )}
                </div>
              </div>
                    ...
                    <div key={index} className="file-item">
                      <div className="file-info">
                        <span className="file-icon">
                          {file.type.includes('pdf') ? '📄' : file.type.includes('image') ? '🖼️' : file.type.includes('zip') ? '📦' : file.name.endsWith('.docx') ? '📄' : '📝'}
                        </span>
